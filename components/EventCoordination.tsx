        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-2/3 text-left">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Sunset Willow Event Planning, LLC partners with The Barn at Sunset
              Farms to provide couples with a stress-free and beautifully
              organized wedding experience. Whether you need full-service
              coordination from engagement to exit, or simply a steady hand on
              the wedding day itself, Sunset Willow ensures every moment flows
              effortlessly.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-2 gap-12">
          <div className="bg-[#FDF8F5] p-8 rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 mb-4">
              A comprehensive planning partnership from start to finish,
              including:
            </p>
          ...
          <div className="bg-[#FDF8F5] p-8 rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-600 mb-4">
              Perfect for couples who have planned their details but want
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-3xl font-bold mb-6">
                Why Couples Choose Sunset Willow
              </h3>
