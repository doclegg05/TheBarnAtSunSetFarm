      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="mt-6 text-lg max-w-3xl mx-auto text-gray-600">
            ...
            weddings, elopements, and family reunions in the heart of Nicholas
            County. Our beautifully crafted barn blends rustic character with
            modern amenities, while our charming cottage provides a perfect
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <img
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).src =
                  'https://placehold.co/800x600/EAD1DC/4a4a4a?text=Upload+real-barn.webp';
              }}
            />
          </div>
          <div className="text-left">
            ...
            <p className="text-gray-600 mb-4">
              With its soaring ceilings, exposed wooden beams, and grand
              chandeliers, the barn is a versatile space that can be transformed
              to match your vision. It comfortably accommodates up to 200
              guests, featuring a spacious dance floor, and panoramic windows
              overlooking the farm.
            </p>
            <p className="text-gray-600">
              Whether you envision a rustic chic gathering or a formal black-tie
              affair, our barn provides the perfect canvas. The space is
              designed to flow seamlessly from your ceremony to cocktail hour
              and reception.
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mt-20">
          <div className="text-left md:order-2">
            ...
            <p className="text-gray-600 mb-4">
              Extend the celebration with an overnight stay in our beautifully
              appointed one bedroom cottage. Perfect for the wedding party or
              out-of-town guests, the cottage offers a peaceful sanctuary with
              modern comforts and picturesque views. Wake up to the serene
          ...
          <div className="rounded-lg overflow-hidden shadow-xl md:order-1 bg-gray-900 h-[400px]">
            ...
            <img
              ...
              onError={(e) => {
                // Fallback if user hasn't uploaded the photo yet
                (e.target as HTMLImageElement).src =
                  'https://placehold.co/800x600/A2B29F/4a4a4a?text=Upload+real-cottage.webp';
              }}
            />
          </div>
        </div>
