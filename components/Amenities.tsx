...
const amenities = [
  ...
  },
  {
    ...
    description:
      'Beautiful covered areas for outdoor ceremonies and cocktail hours.',
  },
  {
    icon: HomeIcon,
    ...
    <div className="mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {amenities.map((item, index) => (
          <div
            key={index}
            className="bg-white p-6 rounded-xl shadow-md border border-gray-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col items-center text-center"
          >
